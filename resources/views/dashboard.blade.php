    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-0 text-muted text-sm">Lihat Detail data <a href="{{ route('pengguna.index') }}">Klik<i
                            class="ti ti-arrow-up-right-circle ms-1"></i></a>
                </p>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mb-3">{{ Buku::count() }}</h4>
                <p class="mb-0 text-muted text-sm">
                    Lihat Detail data <a href="{{ route('buku.index') }}">Klik<i
                            class="ti ti-arrow-up-right-circle ms-1"></i></a>
                </p>
            </div>
        </div>
