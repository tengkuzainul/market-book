<x-layouts.frontend.master :pageName="$pageName ?? $category->nama">
    <!-- Hero Start -->
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12">
                    ...
                    <h1 class="display-3 text-primary mb-3">{{ $category->nama_kategori }}</h1>
                    <p class="mb-5">
                        {{ $category->deskripsi ?? 'Koleksi buku dalam kategori ' . $category->nama_kategori }}</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="d-flex flex-column">
                            @foreach ($categories as $cat)
                                <a href="{{ route('frontend.category', $cat->slug) }}"
                                    class="mb-2 text-dark {{ $cat->id == $category->id ? 'fw-bold text-primary' : '' }}">{{ $cat->nama_kategori }}</a>
                            @endforeach
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex">
                                    ...
                                    <form id="sortForm" action="{{ route('frontend.category', $category->slug) }}"
                                        method="GET">
                    ...
                    <div class="row g-4">
                                ...
                                <div class="border border-primary rounded position-relative vesitable-item">
                                    <div class="vesitable-img">
                                        <a href="#" data-bs-toggle="modal"
                                            ...
                                            <img src="{{ asset($book->gambar_cover) }}"
                        ...
                        @empty
                            <div class="col-12 text-center py-5">
                                <h4>Tidak ada produk yang ditemukan dalam kategori ini</h4>
